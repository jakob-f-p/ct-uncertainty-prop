...
App::Config const App::InitialConfig = Config::DEFAULT;
...
auto App::Run() -> int {
    ...
    InitializeWithTestData(InitialConfig);
...
void App::InitializeWithTestData(Config config) {
    switch (config) {
        case Config::DEFAULT: {
            ...
            { gaussianB1MeanProperty.Get(), gaussianB1MeanProperty.Get() + 100.0F, 50.0F },
            "Mean 1");
        ...
        case Config::SPHERE: {
            ...
            CompositeImageArtifact compositeImageArtifact1;
            compositeImageArtifact1.SetCompositionType(CompositeImageArtifactDetails::CompositionType::SEQUENTIAL);
            auto& composite1 = imageArtifactConcatenationGaussian.AddImageArtifact(std::move(compositeImageArtifact1), &composite);
            BasicImageArtifact gaussianArtifact2(GaussianArtifact{});
            BasicImageArtifact gaussianArtifact3(GaussianArtifact{});
